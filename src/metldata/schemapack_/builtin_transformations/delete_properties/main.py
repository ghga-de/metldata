...
from metldata.schemapack_.builtin_transformations.delete_properties import (
    data_transform,
    model_transform,
)
from metldata.schemapack_.builtin_transformations.delete_properties.assumptions import (
    assert_classes_and_properties_exist,
)
from metldata.schemapack_.builtin_transformations.delete_properties.config import (
