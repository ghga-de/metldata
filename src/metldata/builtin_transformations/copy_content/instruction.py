...
class CopySource(BaseSettings):
    """TODO"""

    relation_path: RelationPath = Field(..., description="")
    content_path: str = Field(..., description="")


class CopyTarget(BaseSettings):
    """TODO"""

    property_name: str = Field(..., description="")
